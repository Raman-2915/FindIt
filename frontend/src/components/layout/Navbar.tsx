    ...
    <header className="sticky top-0 z-30 h-18 border-b border-slate-200 bg-white/90 backdrop-blur-xl">
      <div className="flex h-full items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2 sm:flex">
            <Search size={16} className="text-slate-400" />

            <input
              type="text"
              placeholder="Search items..."
              className="w-44 bg-transparent text-sm text-slate-800 outline-none placeholder:text-slate-400 lg:w-64"
            />
