                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 text-xs text-slate-500">
                      {selectedFoundItem.category?.name || "Uncategorized"} ·{" "}
                      {selectedFoundItem.location} ·{" "}
                      {formatStatus(selectedFoundItem.status)}
                    </p>
                  </div>
                  <Link
                ...
                {claims.map((claim) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {pending &&
                        selectedFoundItem &&
                        selectedFoundItem.status.toUpperCase() === "ACTIVE" && (
                      ...
                      {selectedFoundItem &&
                        selectedFoundItem.status.toUpperCase() === "CLAIMED" &&
                        claim.status.toUpperCase() === "APPROVED" && (
                          <div className="mt-4 flex items-center gap-2 rounded-xl bg-emerald-50 px-4 py-3 text-xs font-semibold text-emerald-700">
                            ...
                            This claim was approved and the found item is now
                            claimed.
                          </div>
                        )}
                    </article>
